...
> **Superseded by [[DD-120]] (2026-07-12). Content re-homed as the knowledge pattern `knowledge/patterns/composable-agent-teams.md` — methodology the engine teaches, not a rule it obeys. The engine's own actor model is DD-82.**
