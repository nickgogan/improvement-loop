...
|---|---|---|---|---|---|
| 2026-04-26 | queued | rule | [[dark-code-organizational-capability-problem]] | "Ship only what at least one human comprehended" | extract via /extract-artifacts |
| 2026-04-26 | queued | skill | [[dark-code-organizational-capability-problem]] | "Comprehension Gate at PR Review" | extract via /extract-artifacts |
| 2026-04-26 | queued | rule | [[distributed-boundary-guides]] | "CLAUDE.md is a symlink to AGENTS.md at every governance boundary" | extract via /extract-artifacts |
| 2026-04-26 | queued | skill | [[specification-as-governance-fourth-enforcement-philosophy]] | "Spec-Driven Development Loop" | extract via /extract-artifacts |
| 2026-04-26 | queued | rule | [[specification-as-governance-fourth-enforcement-philosophy]] | "Spec and code reconcile bidirectionally on every change" | extract via /extract-artifacts |
| 2026-04-26 | queued | rule | [[review-obsolescence-as-design-goal]] | "Every recurring review comment must triage to mechanism or judgment-only" | extract via /extract-artifacts |
| 2026-04-26 | queued | rule | [[compound-review-debt-from-deferred-inspection]] | "Maximum unreviewed depth policy" | extract via /extract-artifacts |
| 2026-04-26 | queued | rule | [[trust-calibration-progressive-autonomy-ramp]] | "Trust promotion thresholds and immediate-demotion triggers" | extract via /extract-artifacts |
| 2026-04-26 | queued | rule | [[agent-identity-governance-enforcement-layer]] | "No agent action proceeds without an identity record bound to the task" | extract via /extract-artifacts |
| 2026-04-26 | queued | rule | [[governance-memory-append-only-audit-layer]] | "Audit log is append-only and never overwritten" | extract via /extract-artifacts |
| 2026-04-26 | queued | template | [[distributed-boundary-guides]] | "Distributed Governance Folder Layout" | dismiss as inline |
| 2026-04-26 | queued | template | [[per-node-tool-restrictions-workflow-governance]] | "Per-Node Tool Restriction YAML" | dismiss as inline |
| 2026-04-26 | queued | template | [[trust-calibration-progressive-autonomy-ramp]] | "Trust Ledger Template" | dismiss as inline |
| 2026-04-26 | queued | template | [[human-on-the-loop-hotl-autonomy-tiering-framework]] | "Four-Level Autonomy Tier Table" | dismiss as inline |
