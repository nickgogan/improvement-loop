...
|---|---|---|---|---|---|
| 2026-04-26 | nick-approved | rule | [[dark-code-organizational-capability-problem]] | "Ship only what at least one human comprehended" | extract via /extract-artifacts |
...
| 2026-04-26 | nick-approved | rule | [[distributed-boundary-guides]] | "CLAUDE.md is a symlink to AGENTS.md at every governance boundary" | extract via /extract-artifacts |
...
| 2026-04-26 | nick-approved | rule | [[specification-as-governance-fourth-enforcement-philosophy]] | "Spec and code reconcile bidirectionally on every change" | extract via /extract-artifacts |
| 2026-04-26 | nick-approved | rule | [[review-obsolescence-as-design-goal]] | "Every recurring review comment must triage to mechanism or judgment-only" | extract via /extract-artifacts |
| 2026-04-26 | nick-approved | rule | [[compound-review-debt-from-deferred-inspection]] | "Maximum unreviewed depth policy" | extract via /extract-artifacts |
| 2026-04-26 | nick-approved | rule | [[trust-calibration-progressive-autonomy-ramp]] | "Trust promotion thresholds and immediate-demotion triggers" | extract via /extract-artifacts |
| 2026-04-26 | nick-approved | rule | [[agent-identity-governance-enforcement-layer]] | "No agent action proceeds without an identity record bound to the task" | extract via /extract-artifacts |
| 2026-04-26 | nick-approved | rule | [[governance-memory-append-only-audit-layer]] | "Audit log is append-only and never overwritten" | extract via /extract-artifacts |
