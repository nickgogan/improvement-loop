...
|---|---|---|---|---|---|
| 2026-07-16 | extracted | template | [[machine-readable-system-contract-with-wiring-rows]] | "System-contract wiring-row schema (five fields)" | extracted to [[system-contract-wiring-row-schema]] |
| 2026-07-16 | extracted | rule | [[invariant-column-as-contract-field]] | "Every wiring row must declare a binary-testable invariant" | extracted to [[wiring-rows-must-declare-testable-invariant]] |
| 2026-07-16 | extracted | skill | [[harness-adaptation-protocol-graded-capability-intersection]] | "Harness adaptation and install protocol" | extracted to [[harness-adaptation-install-protocol]] |
| 2026-07-16 | extracted | template | [[wiring-canon-abstract-then-adapt-doc-structure]] | "Three-section wiring-canon doc format" | extracted to [[three-section-wiring-canon-doc-format]] |
| 2026-07-16 | nick-dismissed | skill | [[dr-research-to-skill-gated-pipeline]] | "Gap-aware research-to-capability pipeline" | dismissed |
| 2026-07-16 | extracted | rule | [[dr-research-to-skill-gated-pipeline]] | "Injection-scan all external content at the write boundary" | extracted to [[injection-scan-at-write-boundary]] |
...
- **Resolution:** extracted to [[system-contract-wiring-row-schema]]

Extracted 2026-07-19 — Session 152 — [[building-agentic-systems.harvest-queue]] — to [[system-contract-wiring-row-schema]].
...
- **Recommendation:** extract via /extract-artifacts
- **Resolution:** extracted to [[wiring-rows-must-declare-testable-invariant]]

Extracted 2026-07-19 — Session 152 — [[building-agentic-systems.harvest-queue]] — to [[wiring-rows-must-declare-testable-invariant]].
...
- **Recommendation:** extract via /extract-artifacts
- **Resolution:** extracted to [[harness-adaptation-install-protocol]]

Extracted 2026-07-19 — Session 152 — [[building-agentic-systems.harvest-queue]] — to [[harness-adaptation-install-protocol]].
...
- **Recommendation:** extract via /extract-artifacts
- **Resolution:** extracted to [[three-section-wiring-canon-doc-format]]

Extracted 2026-07-19 — Session 152 — [[building-agentic-systems.harvest-queue]] — to [[three-section-wiring-canon-doc-format]].
...
Dismissed 2026-07-19 — Session 152 — [[building-agentic-systems.harvest-queue]] — per --harvest-dismiss invocation.
...
- **Recommendation:** extract via /extract-artifacts
- **Resolution:** extracted to [[injection-scan-at-write-boundary]]

Extracted 2026-07-19 — Session 152 — [[building-agentic-systems.harvest-queue]] — to [[injection-scan-at-write-boundary]].
