...
|---|---|---|---|---|---|
| 2026-04-26 | queued | rule | [[catastrophic-context-collapse-risk-during-claudemd]] | "Never ask Claude to compact CLAUDE.md" | extract via /extract-artifacts |
| 2026-04-26 | queued | rule | [[claudemd-context-rot-from-indiscriminate-rule-accu]] | "CLAUDE.md global rule cap" | extract via /extract-artifacts |
| 2026-04-26 | queued | skill | [[trajectory-engineering-non-linear-session-forking]] | "/re Fork-and-Trim Trajectory Procedure" | extract via /extract-artifacts |
| 2026-04-26 | queued | template | [[progress-md-session-bridge]] | "PROGRESS.md Session Bridge Template" | extract via /extract-artifacts |
| 2026-04-26 | queued | template | [[response-format-enum-for-adaptive-verbosity]] | "Tool Response-Format Enum (detailed / concise)" | extract via /extract-artifacts |
| 2026-04-26 | queued | rule | [[skills-as-pointers-to-second-brain-files]] | "Skills reference shared context by path, not by copy" | extract via /extract-artifacts |
| 2026-04-26 | queued | rule | [[ace-delta-updates-over-monolithic-rewrites]] | "Evolving context docs use delta updates, never monolithic LLM rewrites" | extract via /extract-artifacts |
| 2026-04-26 | queued | rule | [[ide-context-streaming-silent-token-tax]] | "Close irrelevant IDE files during agent sessions" | extract via /extract-artifacts |
| 2026-04-26 | queued | rule | [[model-specific-context-file-sensitivity]] | "Test context strategies against your actual model" | extract via /extract-artifacts |
| 2026-04-26 | queued | template | [[five-context-management-techniques-in-claude-code]] | "Context-Management Technique Selector" | dismiss as inline |
| 2026-04-26 | queued | template | [[cross-platform-context-file-strategy]] | "Multi-Tool Context Mirror Map" | dismiss as inline |
| 2026-04-26 | queued | template | [[self-describing-codebase-structural-semantic-context]] | "Module Manifest Template" | dismiss as inline |
| 2026-04-26 | queued | template | [[monorepo-context-distribution-three-strategies]] | "Monorepo Context Distribution Decision Matrix" | dismiss as inline |
| 2026-04-26 | queued | template | [[three-layer-folder-as-workspace-architecture]] | "Three-Layer Folder-as-Workspace Scaffold" | dismiss as inline |
| 2026-04-26 | queued | template | [[three-tier-vault-architecture-global-shared-local]] | "Three-Tier Vault Architecture (Global/Shared/Local)" | dismiss as inline |
| 2026-04-26 | queued | rule | [[session-atomicity-single-issue-scope-quadratic-cost-reduction]] | "Bound each agent session to a single atomic issue" | dismiss as inline |
