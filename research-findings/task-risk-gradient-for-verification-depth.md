...
summary: |-
  Plain English: let AI help everywhere, but don't give every task the same review burden —
...
implementation_notes: |-
  P2: a future /assess-* calibration idea (per the session-135 triage report) — assessor
