...
summary: Coordination mechanism correlates with product architecture across 7 repos. Frameworks use file-based coordination, products use API-based coordination, skill packs use context-window coordination. The mechanism is not a free architectural choice — it follows from the product's nature.
