...
summary: |-
  Plain English: models systematically pick cheap, low-quality designs because they think
...
implementation_notes: |-
  Directly adoptable as a candidate standing rule in the engine's CLAUDE.md / agent
