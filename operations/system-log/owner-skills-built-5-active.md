...
|-------|---------|----------|
| `/translate-governance` | Read MetaSystem constitution, produce IL governance docs, refresh `_governance/` | Guarded |
...
- Refreshed `_governance/` snapshot with current MetaSystem governance source files
