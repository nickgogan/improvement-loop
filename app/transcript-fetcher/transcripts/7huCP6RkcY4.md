...
**[0:02]** playing the game, what's the latest and

**[0:03]** greatest in the AI space, right? It

**[0:05]** changes every single week. And right

**[0:07]** now, everyone is focused on LLM

**[0:10]** knowledge bases, which originated from

**[0:12]** this tweet from Andre Karpathy. And

**[0:14]** there are a lot of really cool ideas

**[0:16]** here that I want to get into with you.

**[0:18]** And I built my own memory system on top

**[0:21]** of this. I think you're really going to

**[0:22]** like it's simple, but super effective.

**[0:25]** So, more on that in a bit, but let's get

**[0:27]** into a bit of context here. So Karpathy

**[0:29]** starts by saying something I'm finding

**[0:30]** very useful recently is using LLM to

**[0:33]** build personal knowledge bases for

**[0:35]** various topics of research interest. So

**[0:38]** taking external information bringing it

**[0:39]** into our own system and organizing it in

**[0:42]** the best way for agents to query. And

**[0:45]** this is a big use case for AI second

**[0:47]** brains right now which is something I've

**[0:49]** been focusing on a lot recently. And I

**[0:51]** love seeing that he's using Obsidian as

**[0:53]** a core part of his stack. I always call

**[0:55]** it my canvas for working with things

**[0:58]** with my second brain. So cool to see

**[0:59]** that. And he really gives us his entire

**[1:02]** playbook here. It's nice and simple. So

**[1:03]** he talks about how he brings in

**[1:05]** information data ingestion, how he views

**[1:07]** it, how he queries it, how he formats

**[1:09]** it, health checks that he's built in as

**[1:11]** well. And so I want to cover this entire

**[1:13]** architecture here and that'll guide us

**[1:16]** into the custom solution that I've built

**[1:18]** on top. And I'm excited to show you this

**[1:20]** because here's the thing. This entire

**[1:22]** thing that he's presenting is working

**[1:23]** with external data which there are a lot

**[1:26]** of use cases for that. But what I've

**[1:28]** built here is working with internal

**[1:30]** data. So giving claude code a memory

**[1:33]** that evolves with your codebase. So

**[1:36]** basing the whole LLM knowledge base on

**[1:38]** our conversations with our coding agent

**[1:40]** or second brain instead of bringing in

**[1:42]** external data. But I've structured

**[1:44]** everything in exactly the same way. all

**[1:46]** of the optimizations for how we index

**[1:49]** and create systems for our agent to

**[1:51]** explore the information. It's really

**[1:53]** cool. So, let's get into the

**[1:54]** infrastructure and then I'll show you

**[1:56]** how you can use this to evolve any

**[1:58]** codebase. And yes, cloud code does

**[2:00]** already have a memory system built in

**[2:02]** and there are open- source solutions out

**[2:04]** there already for claim memory. But I

**[2:06]** wanted to build this specifically

**[2:08]** because I am following everything

**[2:10]** Harpathy laid out here to a tea just for

**[2:12]** internal instead of external

**[2:14]** information. It's a lot simpler than

**[2:16]** other approaches already out there and I

**[2:18]** would argue even more effective. You'll

**[2:20]** see what I mean when we get into it. So,

**[2:22]** something really interesting that he

**[2:23]** says at the top here is he's spending

**[2:25]** more of his tokens with his agents

**[2:26]** manipulating knowledge like Markdown and

**[2:29]** Obsidian instead of manipulating code.

**[2:32]** But he works with knowledge in a very

**[2:34]** similar way that we work with code. That

**[2:36]** brings us to the compiler analogy. This

**[2:38]** is the simplest way to explain

**[2:41]** everything that he's built in the system

**[2:42]** here because the way that we're handling

**[2:44]** knowledge is very similar to how we take

**[2:46]** source code all the way into a final

**[2:49]** application for the end user to run with

**[2:51]** a compiler. And so let let's take it

**[2:54]** from the top here. So we start with our

**[2:55]** source code which for the case of our

**[2:57]** LLM personal knowledge bases, it's our

**[3:00]** articles, papers, anything that we are

**[3:02]** finding online that we want to bring

**[3:04]** into our system. So I'll go to the

**[3:06]** Obsidian vault because this is what

**[3:08]** Karpathi uses. This is what I use for my

**[3:10]** AI second brain. We have the raw folder

**[3:12]** here. This is the entry point into our

**[3:14]** system where we'll dump anything

**[3:16]** articles, papers, transcripts,
...
**[3:39]** scripts. We have code that takes our raw

**[3:41]** information, gives it to an LLM to

**[3:43]** produce the wiki here. So that brings us

**[3:46]** to the next step. The compiler goes to

**[3:48]** the executable. This is what we run or

**[3:50]** in the case of our personal knowledge

**[3:52]** base. This is what we query. So he calls

**[3:54]** it a wiki. This is where we have our

**[3:56]** compiled articles, everything produced

**[3:58]** from the large language model and we

**[4:00]** have the back links. We are connecting

**[4:02]** pieces of knowledge together. So going

**[4:04]** back to Obsidian again, we have our

**[4:06]** graph view. This is one of the coolest

**[4:08]** parts of Obsidian where we can see how

**[4:10]** our different pieces of knowledge, our

**[4:12]** different markdown documents are

**[4:14]** connected together through back links.

**[4:16]** And this is powerful because it gives

**[4:18]** our agent the ability to traverse

**[4:19]** through the graph to search better and

**[4:22]** even connect different pieces of

**[4:24]** knowledge together to give us a more

**[4:26]** comprehensive answer. So this is what we

**[4:28]** run. This is what we search. But before

**[4:30]** we actually get to the final step with

**[4:32]** the runtime, we also have a test suite

**[4:35]** to continue with the analogy of code.

**[4:37]** Here we are performing linting. He calls

**[4:40]** it linting over our documents. So we're

**[4:42]** finding gaps where maybe we need to do

**[4:44]** more research. Any kind of stale data,

**[4:47]** things that maybe we have in our raw

**[4:49]** folder that aren't actually in our wiki

**[4:51]** yet and we need to take care of that

**[4:52]** discrepancy. any kind of broken links.

**[4:55]** Like if we have one document linking to

**[4:56]** another that doesn't exist, we're going

**[4:58]** to take care of all of that. And so

**[5:00]** we're even going so far in this system

**[5:02]** as to making sure that our data has

**[5:05]** integrity. That's pretty important. We

**[5:07]** want to have an accurate personal

**[5:09]** knowledge base. And then finally, we get

**[5:11]** into the last step here where we are

**[5:13]** running queries, right? This is the

**[5:14]** runtime where we are taking advantage of

**[5:16]** our wiki, having our agents search

**[5:18]** through it to find information for what

**[5:20]** we are currently working on. And the

**[5:22]** really interesting thing here is

**[5:23]** Karpathy said, "I thought I had to reach

**[5:25]** for fancy rag, but the large language

**[5:28]** model has been pretty good about

**[5:29]** automaintaining index files." And so one

**[5:32]** of the most important files in this

**[5:34]** entire setup within the wiki, we have

**[5:36]** the index. So this file describes to the

**[5:38]** agent here are all the different folders

**[5:41]** and resources that you have access to.

**[5:43]** So it uses this as a starting point. So

**[5:45]** we don't even have to do fancy rag. The

**[5:48]** agent can just navigate through all the

**[5:50]** files that we have as marked on in our

**[5:52]** obsidian vault. It doesn't have to do

**[5:53]** any semantic search. There's no vector
...
**[6:06]** flow. I think this will really take it

**[6:08]** home for you. Then we'll get into my

**[6:10]** implementation that I built on top. I'll

**[6:11]** talk about how it relates to all these

**[6:13]** ideas here. So, okay, we start with our

**[6:15]** external information, and Carpathy

**[6:18]** specifically calls out the Obsidian Web

**[6:21]** Clipper. It's a really neat extension to
...
**[6:29]** this case, right into our raw folder,

**[6:31]** the source of truth, like we talked

**[6:33]** about earlier, the unprocessed markdown

**[6:35]** that we feed that into the large

**[6:36]** language model to create our wiki for

**[6:39]** us. And so, I've built up a simple

**[6:41]** example here for demonstration. My raw

**[6:43]** folder just has some different articles

**[6:45]** on AI topics. And then within the wiki,

**[6:48]** this is what is processed. This is what

**[6:50]** our agent actually queries. We have this

**[6:52]** concepts folder and this is where we tie
...
**[7:09]** highle idea of where it's going to start

**[7:11]** looking based on our question. And then

**[7:14]** the last thing that we have here is the

**[7:16]** agents.mmd. So this is like global rules

**[7:18]** for your coding agent, right? And so

**[7:20]** really what we do in our global rules

**[7:22]** here is we're describing the entire

**[7:25]** system for LLM knowledge bases so the

**[7:27]** agent understands here's where my

**[7:30]** information comes from. Here's the

**[7:31]** compiled version that I'm going to
...
**[7:50]** knowledgebased system for yourself, all
...
**[7:59]** Karpathy. He had a follow-up tweet where

**[8:01]** he linked to this. This is essentially a
...
**[8:16]** going to oneshot the whole thing for

**[8:18]** you. And that's what I built into my

**[8:20]** version as well. If you look at the

**[8:22]** readme here for the quick start, you

**[8:24]** don't even have to clone the repo
...
**[8:32]** hooks, everything that I have to make

**[8:34]** this LLM personal knowledge base, but

**[8:37]** for internal information instead of

**[8:39]** external. So, inspired by the entire

**[8:42]** architecture we just covered here, but

**[8:43]** that's the key difference is now this is

**[8:45]** giving Claude code a memory that evolves

**[8:47]** with your codebase. So, instead of

**[8:49]** taking things from the internet, we are

**[8:51]** going to automatically capture session

**[8:53]** logs with hooks. And so session logs are

**[8:56]** kind of like the raw folder where we're

**[8:58]** just putting in our conversations and

**[9:00]** then we're going to use the claude agent

**[9:02]** SDK behind the scenes to automatically

**[9:04]** extract everything into structured cross

**[9:07]** reference knowledge articles. So your

**[9:10]** coding agent like you can do this per

**[9:11]** codebase. It's going to get smarter and

**[9:13]** smarter over time because it remembers

**[9:15]** the decisions you've made and how you've

**[9:17]** evolved your project. The sponsor of

**[9:19]** today's video is InsForge. Insorgge is

**[9:22]** an open- source platform that gives your

**[9:24]** coding agent everything it needs to ship

**[9:26]** full stack apps. Think if you had

**[9:28]** Verscell, Superbase, and Open Router all

**[9:30]** in one platform. So we have a database,

**[9:34]** we've got authentication, storage, we
...
**[9:48]** less than 5 minutes to install the

**[9:49]** InsForge CLI and skill on any codebase.

**[9:52]** And then I can go into cloud code and

**[9:54]** prompt it to create an application. So

**[9:55]** here I'll have it make both a backend

**[9:57]** and a front end. And I'm specifically

**[9:59]** asking it to use infors to create my
